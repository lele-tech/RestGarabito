export function Title_Light() {
    return (
        <div className='bg-soft-sand flex w-full h-full mx-auto max-w-screen-sm md:max-w-screen-lg xl:max-w-screen-2xl pt-10 xl:mb-20 2xl:mb-28 2xl:pt-16 overflow-x-hidden'>
            ...
            <div className='w-1/2 justify-center items-center drop-shadow-md absolute hidden xl:flex'>
                ...
                />
                <div className="absolute h-24 w-full bg-cocoa-bark xl:left-[58.2rem] transform translate-y-[1rem]">
        ...
        <div className='flex bg-cocoa-bark w-full h-full mx-auto max-w-screen-sm md:max-w-screen-lg xl:max-w-screen-2xl pt-10 xl:pt-16 xl:pb-28'>
            ...
            <div className="w-full xl:w-1/2 h-full drop-shadow-md xl:pt-16 ml-auto ">
                ...
                <div className='m-10 text-soft-sand'>
                    <h2 className='text-2xl md:text-7xl xl:text-5xl 2xl:text-7xl font-righteous tracking-[1rem] text-center md:-mb-2'>restaurante</h2>
                    <h1 className="text-5xl md:text-9xl xl:text-7xl 2xl:text-9xl font-righteous text-center">
                        Palenque
                    </h1>
                    <h1 className="text-5xl md:text-9xl xl:text-7xl 2xl:text-9xl font-righteous text-center">
                        Garabito
                    </h1>
                    <p className="text-2xl md:text-3xl xl:text-2xl 2xl:text-3xl font-righteous text-center">La Parada Inteligente</p>
                </div>
            </div>
            {/* Fin Texto */}
