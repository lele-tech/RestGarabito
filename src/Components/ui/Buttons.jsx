...
export function Button({
  ...
  return (
    <button
      ...
      id={id}
      onClick={onClick}
      className={`text-white font-poppins font-semibold text-center rounded-lg transition-all
        duration-300  ease-in-out hover:scale-105 flex items-center justify-center py-2 px-10 h-16 bg-cocoa-bark bg-gradient-to-b from-cocoa-bark to-black/0  ${bgClasses}  ${extraStyles}`}
    >
      {text}
    </button>
  );
