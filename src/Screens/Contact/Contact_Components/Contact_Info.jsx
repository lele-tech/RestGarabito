...
export function Contact_Info() {
    return (
        <div className='flex h-full mt-24'>
            <div className='w-[20%] h-full bg-dawn-pink absolute right-0 top-0 hidden xl:visible'>

            </div>

            <div className='w-full xl:absolute drop-shadow-xl bg-cocoa-bark py-10 xl:py-20 px-20 z-10'>
                <div className='w-20 h-20 drop-shadow-xl bg-dawn-pink absolute -left-10 -top-10 z-10  hidden xl:visible'>
                </div>

                <div className='-ml-6 md:ml-16 xl:ml-0'>
                    <h1 className='text-4xl md:text-5xl font-righteous text-dawn-pink'>Información</h1>
