...
export function About() {
  return (
    <>
      ...
      <div className="bg-[#4D3B2A] text-[#EDE0D4] min-h-screen flex flex-col md:flex-row px-4 md:px-12">
        {/* Lado Izquierdo */}
        <div className="w-full md:w-1/2 flex flex-col justify-center py-8">
          ...
          <div className="flex flex-col items-start justify-center">
            ...
            <img
              src="/imgs/logo_palenque.png"
              alt="Decoración"
              className="w-75 h-72 object-contain mx-auto"
            />
          </div>
        </div>
