...
export function Home_Discover() {
  return (
    <div className="xl:flex w-full mt-10 mx-auto mb-24 2xl:mb-24 xl:mt-0 2xl:mt-10">
      {/* Inicio Texto */}
      <div className="w-full xl:w-1/2 h-full xl:pt-12 2xl:pt-2 xl:ml-16 2xl:ml-48">
      ...
      <div className="w-full xl:w-1/2 h-full justify-center items-center drop-shadow-md  hidden xl:flex overflow-hidden xl:mt-8 2xl:mt-6">
        <div className="mx-auto xl:mx-0 w-[20rem] h-[20rem] 2xl:w-[28rem] 2xl:h-[28rem] bg-cocoa-bark rounded-full">
          <div className="mx-auto xl:mx-0 w-[16rem] h-[16rem] 2xl:w-[26rem] 2xl:h-[24rem] rounded-xl bg-coral-reef xl:-top-5 xl:-right-20 ">
            {imageAvailable ? (
              <img
